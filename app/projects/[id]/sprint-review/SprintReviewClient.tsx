          ...
          {hasReq ? (
            <>
              ...
              {doneItems.length > 0 && (
                <section>
                  <div className="flex items-center gap-3 mb-4">
                    <p className="text-[20px] font-semibold text-[var(--status-green)]">เสร็จแล้ว</p>
              ...
              {partialItems.length > 0 && (
                <section>
                  <div className="flex items-center gap-3 mb-4">
                    <p className="text-[20px] font-semibold text-[var(--status-yellow)]">ไม่ถูกต้อง</p>
              ...
              {noReqItems.length > 0 && (
                <section>
                  <div className="flex items-center gap-3 mb-4">
                    <p className="text-[20px] font-semibold text-[var(--text-muted)]">ไม่มีใน Requirement</p>
              ...
              {notDoneItems.length > 0 && (
                <section>
                  <div className="flex items-center gap-3 mb-4">
                    <p className="text-[20px] font-semibold text-[var(--status-red)]">ยังไม่ครบ</p>
